...
enum {
	...
	US_SOLOANIM_2   = (1 << 15),
	US_REMOVED = (1 << 16),
	US_BIT17 = (1 << 17), //something1
	US_BIT18 = (1 << 18), //something2
	US_BIT19 = (1 << 19), //super arena mode?
	US_BIT20 = (1 << 20), //not deployed in previous chapter
	US_BIT21 = (1 << 21), //cutscene unit
	US_BIT22 = (1 << 22), //increase portrait index by 1
	US_BIT23 = (1 << 23), //makes map sprite shake
	US_BIT24 = (1 << 24), //unit not able to participate in chapter
	US_NOT_DEPLOYABLE = US_BIT24,
	US_BIT25 = (1 << 25),
	US_REMOVED_2 = (1 << 26),
	US_BIT27 = (1 << 27),
	US_JAILED = (1 << 28),
	...
	// Helpers
	US_UNAVAILABLE = (US_DEAD | US_NOT_DEPLOYED | US_REMOVED),
};
